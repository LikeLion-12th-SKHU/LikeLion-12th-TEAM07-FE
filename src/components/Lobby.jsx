        ...
        <LobbyBody>
          <Category>
            ...
            <DetailCategory>
              ...
              <ElementR onClick={handleCreateGameClick}>방 만들기</ElementR>
              <ElementH onClick={handleHomeClick}>홈으로 가기</ElementH>
              <ElementS
                onClick={() => {
                  effectSound.current.playSound();
                  openSetting();
              ...
              <ElementRank onClick={handleRankingClick}>랭킹 보기</ElementRank>
            </DetailCategory>
