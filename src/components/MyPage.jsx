...
const categories = [
  {
    name: "신체 건강",
    words: [
      { word: "운동", description: "신체 활동을 통해 건강을 증진시키는 활동." },
      {
        word: "영양",
        description: "신체가 필요로 하는 필수 영양소를 섭취하는 것.",
      },
      { word: "다이어트", description: "체중 조절을 위한 식사 및 운동 계획." },
      ...
      { word: "심폐 지구력", description: "심장과 폐의 건강을 유지하는 능력." },
      { word: "대사", description: "신체가 에너지를 생성하고 사용하는 과정." },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "감정 조절", description: "감정을 효과적으로 통제하는 능력." },
      {
        word: "우울증",
      ...
      { word: "마음 챙김", description: "현재 순간에 집중하는 정신적 연습." },
      { word: "긍정적 사고", description: "긍정적인 방식으로 생각하는 습관." },
    ],
  },
  {
    name: "예방 및 관리",
    words: [
      { word: "건강검진", description: "정기적으로 건강 상태를 점검하는 것." },
      {
        word: "예방 접종",
        description: "질병을 예방하기 위해 백신을 맞는 것.",
      },
      { word: "검진", description: "질병이나 이상을 확인하기 위한 검사." },
      { word: "정기 검사", description: "건강 상태를 정기적으로 검사하는 것." },
      { word: "스크리닝", description: "질병의 조기 발견을 위한 검사." },
      { word: "건강 보험", description: "의료비를 지원하는 보험." },
      { word: "예방 의학", description: "질병을 예방하는 데 중점을 둔 의학." },
      {
        word: "건강 관리 계획",
  ...
  },
  {
    ...
    words: [
      ...
      { word: "미네랄", description: "신체 기능을 유지하는 데 필요한 무기질." },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "규칙적인 생활", description: "일정한 생활 패턴을 유지하는 것." },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "소화", description: "음식을 분해하여 영양소를 흡수하는 과정." },
    ],
  },
];
      ...
      <LogoContainer>
        ...
        <Header>
          <h1>
            ...
            <NavLinks onClick={() => navigate("/ranking")}>마이페이지</NavLinks>
          </h1>
        </Header>
      </LogoContainer>
